...
DEFAULT_VAL_JSON="${REPO_ROOT}/data/anno_data/PointLLM_brief_description_val_200_GT.json"
DEFAULT_HEAD_DIR="${REPO_ROOT}/outputs/pointllm_eagle_head"
DEFAULT_OUTPUT_JSONL="${REPO_ROOT}/outputs/pointllm_compare_eagle.jsonl"
DEFAULT_SUMMARY_JSON="${REPO_ROOT}/outputs/pointllm_compare_eagle_summary.json"
